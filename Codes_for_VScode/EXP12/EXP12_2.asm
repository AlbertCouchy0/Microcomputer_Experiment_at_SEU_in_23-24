...
FREQ 	DW  660,784,784,880,784,660,524,524,588	;查表可得频率
        	DW  660,660,588,524,588
        	DW  660,784,784,880,784,660,524,524,588
        	DW  660,660,588,588,524,0

TIME	DW  50,50,75,25,50,50,50,25,25        ;多少个10ms
        	DW  50,50,50,50,200
        	DW  50,50,75,25,50,50,50,25,25
        	DW  50,50,50,50,200,0
DATA    ENDS
