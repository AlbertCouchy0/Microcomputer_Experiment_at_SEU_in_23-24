...
SLEN11 EQU $-LINE11;
LINE12   DB  0AH,0DH,'                    Oh oh oh oh oh oh oh oh woo~ oh oh oh oh'
SLEN12 EQU $-LINE12;
LINE13   DB  0AH,0DH,'                    Things I do not want to forget'
SLEN13 EQU $-LINE13;
LINE14   DB  0AH,0DH,'                    Oh oh oh oh oh oh oh oh woo~ oh oh oh oh'     
SLEN14 EQU $-LINE14;
...
;清屏
    ...
    MOV DH,24
    MOV DL,79
    MOV BH,00110111B	;不闪烁（0），青底（011），高亮（1），白字（111）
    INT 10H
;输出
    MOV AH,13H			; 调用功能号13H
    MOV	DH,0AH			;行
